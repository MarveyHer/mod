...
internal static class UIManager
{
	public static void init()
	{
		...
		PowerButtonCreator.AddButtonToTab(PowerButtonCreator.CreateWindowButton("NML_ModsList", "NeoModList", InternalResourcesGetter.GetIcon()), PowerButtonCreator.GetTab("main"), (int?)22);
	}
}
