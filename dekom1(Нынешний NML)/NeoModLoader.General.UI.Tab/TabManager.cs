...
public static class TabManager
{
	...
	public static PowersTab CreateTab(string name, string pTitleKey, string pDescKey, Sprite pIcon, string pOptionDescKey = "hotkey_tip_tab_other")
	{
		...
		PowersTab tab = Object.Instantiate<PowersTab>((from tgo in ResourcesFinder.FindResources<GameObject>("units")
			select tgo.GetComponent<PowersTab>()).First((PowersTab t) => (Object)(object)t != (Object)null), tab_container);
		...
		for (int num = 6; num < ((Component)tab).transform.childCount; num++)
		{
		...
		{
			power_button.findNeighbours(tab._power_buttons, false);
		}
	...
	static TabManager()
	{
		...
		tab_container = ((Component)CanvasMain.instance.canvas_ui).transform.Find("CanvasBottom/BottomElements/BottomElementsMover/CanvasScrollView/Scroll View/Viewport/Content/Power Tabs");
